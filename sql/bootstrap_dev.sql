...
CREATE SCHEMA IF NOT EXISTS PLATFORM_DEV.DBT_RUNTIME;
CREATE SCHEMA IF NOT EXISTS PLATFORM_DEV.DBT_DEPLOYMENT;
...
GRANT USAGE ON SCHEMA PLATFORM_DEV.DBT_RUNTIME TO ROLE ROLE_DEV_DBT;
GRANT USAGE ON SCHEMA PLATFORM_DEV.DBT_DEPLOYMENT TO ROLE ROLE_DEV_DBT;
GRANT CREATE DBT PROJECT ON SCHEMA PLATFORM_DEV.DBT_DEPLOYMENT TO ROLE ROLE_DEV_DBT;
GRANT CREATE TASK ON SCHEMA PLATFORM_DEV.DBT_DEPLOYMENT TO ROLE ROLE_DEV_DBT;
GRANT CREATE TABLE, CREATE VIEW ON SCHEMA PLATFORM_DEV.DBT_RUNTIME TO ROLE ROLE_DEV_DBT;
