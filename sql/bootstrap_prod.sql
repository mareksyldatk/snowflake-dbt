...
-- BI analyst inherits BI gold read access, then adds SILVER read.
...
-- BI Analyst: read SILVER (DIMENSIONS + FACTS).
GRANT USAGE ON SCHEMA ANALYTICS_PROD.DIMENSIONS TO ROLE ROLE_PROD_BI_ANALYST;
GRANT SELECT ON ALL TABLES IN SCHEMA ANALYTICS_PROD.DIMENSIONS TO ROLE ROLE_PROD_BI_ANALYST;
GRANT SELECT ON FUTURE TABLES IN SCHEMA ANALYTICS_PROD.DIMENSIONS TO ROLE ROLE_PROD_BI_ANALYST;
GRANT SELECT ON ALL VIEWS IN SCHEMA ANALYTICS_PROD.DIMENSIONS TO ROLE ROLE_PROD_BI_ANALYST;
GRANT SELECT ON FUTURE VIEWS IN SCHEMA ANALYTICS_PROD.DIMENSIONS TO ROLE ROLE_PROD_BI_ANALYST;

GRANT USAGE ON SCHEMA ANALYTICS_PROD.FACTS TO ROLE ROLE_PROD_BI_ANALYST;
GRANT SELECT ON ALL TABLES IN SCHEMA ANALYTICS_PROD.FACTS TO ROLE ROLE_PROD_BI_ANALYST;
GRANT SELECT ON FUTURE TABLES IN SCHEMA ANALYTICS_PROD.FACTS TO ROLE ROLE_PROD_BI_ANALYST;
GRANT SELECT ON ALL VIEWS IN SCHEMA ANALYTICS_PROD.FACTS TO ROLE ROLE_PROD_BI_ANALYST;
GRANT SELECT ON FUTURE VIEWS IN SCHEMA ANALYTICS_PROD.FACTS TO ROLE ROLE_PROD_BI_ANALYST;
